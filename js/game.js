class Game {
    constructor(canvas, context) {
        ...
        this.canvas.addEventListener('mouseup', e => { //Player Spritesheet 
            this.player.wingsUp(); //Player Spritesheet 
        }); //Player Spritesheet 
        ...
        window.addEventListener('keydown', e => {
            ...
            if(e.key.toLowerCase() === 'r')  { // Restart
                this.resize(window.innerWidth, window.innerHeight); // Restart
            } // Restart
        ...
        window.addEventListener('keyup', e => { //Player Spritesheet 
            this.player.wingsUp(); //Player Spritesheet 
        }); //Player Spritesheet 
